...
public class SalesPageAdapter extends BaseAdapter {
    ...
    public SalesPageAdapter(Context mContext, ArrayList<LoginBean> login_Userlist) {
...
//                    Toast.makeText(mContext, "No user found.", Toast.LENGTH_SHORT).show();
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            Log.e("Adapter", "Values Are :----->>> "+loginBean.getUsername() );
            Log.e("Adapter", "Values Image :----->>> "+loginBean.getImageurl() );
